      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Debitor Payment details</li>
          </ol>
                ...
                <div class="card-body p-1">
                    <div class="row p-1">   <!--Ref https://www.w3schools.com/php/func_date_date_format.asp-->
                        <div class="col-md-6" style="align:right;"> <!--dS gives 11th M gives month name and Y gives year-->
                           <h2><p class="font-weight-bold mb-1">Debitor Payment details</p></h2>
                            <p class="text-muted">As of Order Reference: <strong><?=$oname ?></strong> added on: <strong><?=date("jS M,Y", strtotime($odate));?></strong></p>
                        </div>
                        <div class="col-md-6" >
                            <h2><p class="font-weight-bold mb-1">Customer Name</p></h2>
                    ...
                    <hr class="my-3">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('Orders/AddDebitEntery/'.$ID)?>" method="post">
                            ...
                            <table class="table table-striped table-hover">
                              <thead>
                                <tr>
                                  ...
                                  <th class="border-0 text-uppercase small font-weight-bold">Amount recieved</th>
                              ...
                              <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=anchor("Orders/DeleteDebitEntery/".$p->id."/".$ID,"Delete",array('onclick' => "return confirm('Do you want delete this record')" ,'class' => "btn btn-sm btn-danger"))?></td>
                                    </tr>
                                    <?php
                                         }//End Of ForEach
                                    } //End of if
                    ...
                    <div class="d-flex flex-row-reverse bg-dark text-white p-1">
                        ...
                        <div class="py-3 px-5 text-right">
                            <div class="h3 mb-1">Due Recieving</div>
