    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        <li class="nav-item active">
          <a class="nav-link" href="Welcome/index">
...
<!-- End of pages Section -->
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
        <a class="nav-link" href="Welcome/Addsupplier">
            <!-- <i class="fas fa-fw fa-chart-area"></i> -->
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="#" class="MyBreadCrumps">Dashboard</a>
            </li>
            <li class="breadcrumb-item active">Current View Page</li>
          </ol>
