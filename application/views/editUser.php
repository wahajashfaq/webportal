...
<form class="form-horizontal" action="<?php echo base_url()?>User/updateUser" method="post">
<fieldset>
   ...
   <div class="col-md-4 ">
    <div class="form-group">
      ...
      <input id="name" name="name" type="text" value="<?php echo $user->Name?>" class="form-control input-md" required="">
        <?php echo form_hidden('info_id', $user->u_ID, 'id="info_id"'); ?>
    </div>
...
<div class = "row">
   <div class="col-md-4 ">
    ...
    <input id="password" name="password" type="text" value="<?php echo $user->u_pass?>" class="form-control input-md" required="">       
    </div>
   </div>
